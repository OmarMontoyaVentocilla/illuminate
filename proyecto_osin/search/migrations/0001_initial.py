# Generated by Django 2.0.4 on 2018-07-17 21:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(max_length=2)),
                ('idfb', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='search.Facebook')),
                ('idpersona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='persona.Persona')),
            ],
        ),
        migrations.CreateModel(
            name='Twitter',
        ...
        migrations.AddField(
            ...
            name='idtw',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='search.Twitter'),
        ),
        migrations.AddField(
            model_name='personaredes',
            name='idusuario',
